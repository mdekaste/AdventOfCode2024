...
sealed class DotGraph(
     ...
     *  hence why these return a core.DotEdgeStmt and not the rhs
     */
...
/**
 * Calling a core.DotVertex entities that can be the source or target of an edge -- i.e. node ids and subgraphs
